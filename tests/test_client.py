    ...
    "facts": {
        "us-gaap": {
            ...
            "Assets": {
                "label": "Assets",
                "units": {
                    "USD": [fact(359_241_000_000), previous_fact(364_980_000_000)]
                },
            },
            "Liabilities": {
                "label": "Liabilities",
                "units": {
                    "USD": [fact(285_508_000_000), previous_fact(308_030_000_000)]
                },
            },
...
class SecClientTests(unittest.TestCase):
    ...
    def test_compares_two_10ks_and_links_every_change_to_both_filings(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            self.assertIn("Apple annual filing change report", report_html)
